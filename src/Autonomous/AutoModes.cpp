...
{    
    ...
    m_Modes["Double Scale Left"];
      ...
      m_Modes["Double Scale Left 2"].push_back(RobotCommand(CMD_AUTO_REV, -60, -160, 0.2, CONSTANT("ELEVATOR_SCALE"), 0.6));
      m_Modes["Double Scale Left 2"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -60, -160, 0.2, CONSTANT("ELEVATOR_SCALE"), 0.5));
      m_Modes["Double Scale Left 2"].push_back(RobotCommand(CMD_HOLD_DISTANCE, -60, -160, 0.2, 0, 2));
